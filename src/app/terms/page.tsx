          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                By accessing and using BookLever ("the Service"), you accept and agree to be bound by 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                BookLever is a digital library management platform that allows users to:
              </p>
              <ul className="list-disc pl-6 text-gray-700 mb-4">
                <li>Upload and organize digital books</li>
                <li>Read books across multiple devices</li>
                <li>Create highlights and annotations</li>
                <li>Sync reading progress</li>
                <li>Search within their library</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                The Service and its original content, features, and functionality are owned by BookLever 
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                In no event shall BookLever, nor its directors, employees, partners, agents, suppliers, 
